...
app.get("/api/prospects/:prospectId/leads/:leadId/needs-assessment", async (req, res) => {
  try {
    ...
    let needsAssessment = await NeedsAssessment.findOne({ leadEngagementId: engagement._id })
      .select("attendanceConfirmed attendedAt needsAnalysisCompletedAt proposalPresentationScheduledAt dependents")
      .lean();
    ...
    return res.json({
      ...
      needsAssessment: {
        currentActivityKey: engagement.currentActivityKey || "Record Prospect Attendance",
