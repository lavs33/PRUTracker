  ...
  try {
    ...
    return res.json({
      ...
      branches: branches.map((branch) => ({
        ...
        areaName: areas.find((area) => String(area._id) === String(branch.areaId))?.areaName || "",
        createdAt: branch.createdAt || null,
        updatedAt: branch.updatedAt || null,
      })),
      units: units.map((unit) => ({
        ...
        branchName: branches.find((branch) => String(branch._id) === String(unit.branchId))?.branchName || "",
        areaName:
          areas.find(
            (area) =>
              String(area._id) ===
              String(branches.find((branch) => String(branch._id) === String(unit.branchId))?.areaId || "")
          )?.areaName || "",
        createdAt: unit.createdAt || null,
        updatedAt: unit.updatedAt || null,
      })),
