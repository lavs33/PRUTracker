  ...
  try {
    ...
    await Notification.create([
      ...
      },
      {
        ...
        createdAt: new Date(orphanNotificationCreatedAt.getTime() + 4),
        updatedAt: new Date(orphanNotificationCreatedAt.getTime() + 4),
      },
    ], { timestamps: false });

    if (taskNotificationPayload?.task) {
      const task = taskNotificationPayload.task;
      const taskAddedAt = new Date(orphanNotificationCreatedAt.getTime() + 3);
      await Notification.updateOne(
