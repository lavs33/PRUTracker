...
async function syncBmRecommendationResolutionsForUser(userId) {
  ...
  }), { annualPremium: 0, totalPolicies: 0, activePolicies: 0 });
  ...
  const actualByKey = {
    ...
    monthly_persistency_rate: branchSummary.totalPolicies ? Math.round((branchSummary.activePolicies / branchSummary.totalPolicies) * 100) : 0,
  };
