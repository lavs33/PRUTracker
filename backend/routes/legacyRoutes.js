...
app.get("/api/clients/relationship/dashboard", async (req, res) => {
  try {
    ...
    const policyholderTrend = buildSeries(activePolicyholders, "createdAt");
    ...
    return res.json({
      ...
      conversionRatePct: toPct(totalActivePolicyholders, totalProspects),
      warmRatePct: toPct(warm, totalProspects),
      sourceRatePct: toPct(agentSourced, totalProspects),
      activePolicyRatePct: toPct(totalActivePolicyholders, totalProspects),
