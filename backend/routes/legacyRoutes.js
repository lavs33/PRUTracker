  ...
  try {
    ...
    const rangeContext = (() => {
      if (selectedPreset === "YTD") {
        ...
        return {
          startDate: new Date(Date.UTC(currentYear, 0, 1) - (8 * 60 * 60 * 1000)),
          endDate: now,
          periodLabel: `January ${currentYear} - ${monthLabel} ${currentYear}`,
        };
      }
    ...
    prospectQuery.createdAt = { $gte: startDate, $lte: endDate };
