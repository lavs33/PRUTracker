...
app.get("/api/policyholders/:policyholderId/details", async (req, res) => {
  try {
    ...
    const policyholder = await Policyholder.findOne({
      ...
      .select("policyholderCode productId policyNumber leadEngagementId lastPaidDate nextPaymentDate status createdAt updatedAt")
      .lean();
      ...
      engagement: {
        ...
        application: {
          ...
          recordPremiumPaymentTransfer: {
            ...
            paymentProofFileName:
              ...
              || "",
            savedAt: paymentDoc?.recordPremiumPaymentTransfer?.savedAt || null,
          },
        ...
        policy: {
          ...
          uploadInitialPremiumEor: {
            ...
            eorNumber: paymentDoc?.uploadPremiumPaymentEor?.eorNumber || "",
            receiptDate: paymentDoc?.uploadPremiumPaymentEor?.receiptDate || null,
            eorFileName: paymentDoc?.uploadPremiumPaymentEor?.eorFileName || "",
            eorFileMimeType: paymentDoc?.uploadPremiumPaymentEor?.eorFileMimeType || "",
            eorFileDataUrl: paymentDoc?.uploadPremiumPaymentEor?.eorFileDataUrl || "",
            uploadedAt: paymentDoc?.uploadPremiumPaymentEor?.uploadedAt || null,
          },
          uploadPolicySummary: {
