  ...
  try {
    ...
    if (normalizedStatus === "Issued") {
      ...
      if (!issuanceDateRaw) {
        ...
        } else if (applicationSubmittedDateStart && issuanceDateValue < applicationSubmittedDateStart) {
          fieldErrors.issuanceDate = "Issuance date cannot be earlier than application submission date.";
        }
      }
    }
    ...
    if (normalizedStatus === "Declined") {
      ...
      if (!declinedDateRaw) {
        ...
        } else if (applicationSubmittedDateStart && declinedDateValue < applicationSubmittedDateStart) {
          fieldErrors.declinedDate = "Date declined cannot be earlier than application submission date.";
        }
      }
