 ...
 *
 * Setup:
 * - Edit BOOTSTRAP_ADMIN below before running this script.
 * - Do NOT reuse the MongoDB URI username/password here.
 *   Those are database credentials, not the app admin login.
 *
 * Usage:
