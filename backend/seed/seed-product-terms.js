...
const PRODUCT_REQUIREMENTS = {
  ...
  "PRUTerm Lindungi": { ageRequirement: { minAge: 18, maxAge: 60, label: "18 - 60" }, minimumSumAssured: { hasStandard: true, amount: 100000, label: "100,000" }, minimumAnnualPremium: { hasStandard: false, amount: null, label: "No standard" } },
