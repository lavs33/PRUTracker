...
async function backfillPaymentRecords() {
  ...
  const applications = await Application.find({
    $or: [
      ...
      { "recordPremiumPaymentTransfer.totalFrequencyPremiumPhp": { $ne: null } },
      { "recordPremiumPaymentTransfer.paymentDate": { $ne: null } },
      { "recordPremiumPaymentTransfer.methodForInitialPayment": { $exists: true, $ne: "" } },
      { "recordPremiumPaymentTransfer.paymentProofImageDataUrl": { $exists: true, $ne: "" } },
      { "recordPremiumPaymentTransfer.paymentProofFileName": { $exists: true, $ne: "" } },
    ],
  })
