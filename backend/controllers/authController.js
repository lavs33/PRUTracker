function createAuthController({
  ...
  const getManagerPortal = async (req, res) => {
    try {
      const { userId, taskDatePreset = "ALL", salesDatePreset = "ALL", unitPerformanceDatePreset = "ALL", reassignmentMonth = "" } = req.query;
      ...
      const result = await buildManagerPortalPayload(user, { taskDatePreset, salesDatePreset, unitPerformanceDatePreset, reassignmentMonth });
      if (result.error) {
