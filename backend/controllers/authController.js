function createAuthController({
  ...
  const getManagerPortal = async (req, res) => {
    try {
      const { userId, taskDatePreset = "ALL", salesDatePreset = "ALL", kpiDatePreset = "DEFAULT" } = req.query;
      ...
      const result = await buildManagerPortalPayload(user, { taskDatePreset, salesDatePreset, kpiDatePreset });
      if (result.error) {
