  ...
  const moduleCards = [
    {
      ...
      accent: "clients",
      insights: [
        { label: "Active prospects", value: homeData.clients.activeProspects },
    ...
    },
    {
      ...
      accent: "tasks",
      insights: [
        { label: "Open tasks", value: homeData.tasks.openCount },
        { label: "Due today", value: homeData.tasks.dueTodayCount },
      ],
    },
    {
      key: "sales",
      ...
      accent: "sales",
      insights: [
        { label: "Active-policy conversion", value: `${homeData.sales.conversionRatePct}%` },
        { label: "Active annual premium", value: `₱ ${money(homeData.sales.totalAnnualPremiumPhp)}` },
      ],
    },
    {
      key: "kpi-progress",
      ...
      accent: "kpi",
      insights: [
        { label: "Assigned KPIs", value: homeData.kpiProgress.assignedCount },
