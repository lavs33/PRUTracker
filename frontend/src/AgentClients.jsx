                  ...
                  <tbody>
                    {recentPolicyholders.map((c) => {
                      ...
                      return (
                        ...
                        <td>
                          <span
                            className={`status-pill ${c.status === "Active" ? "active" : (c.status === "At Risk" ? "at-risk" : (c.status === "Lapsed" ? "lapsed" : (["Cancelled", "Paid-Up", "Matured"].includes(c.status) ? "cancelled" : "nurture")))}`}
                          >
                            {c.status || "—"}
                          </span>
                        </td>
