        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; }
            ...
            .pdf-page { position: relative; min-height: 297mm; padding: 10mm 10mm 16mm; overflow: hidden; }
            ...
            return (
              <section className="agent-kpi-contribution-card">
                ...
                <div className="agent-kpi-values">
                  ...
                  <div>
                    <span>Unit Sales Production Target</span>
