...
const getKpiComparison = (actual, kpi = {}) => {
  ...
  if (delta > 0) {
    return { percent, status: "Exceeded target", className: "good", deltaLabel: `Exceeding target by ${formatKpiValue(delta, kpi.valueType)}` };
  }
  if (delta === 0) {
    return { percent, status: "On target", className: "good", deltaLabel: "" };
  }
