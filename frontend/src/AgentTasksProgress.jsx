      ...
      pages.push(`
        <section class="pdf-page">
          <section class="section compact-top">
            ...
            <table>
              <thead><tr><th>Title</th><th>Type</th><th>Status</th><th>Overdue Open</th><th>Was Delayed</th><th>Completed At</th><th>Due</th><th>Lead Code</th><th>Prospect</th><th>Lead Status</th></tr></thead>
              <tbody><tr><td colspan="10">No task detail rows available.</td></tr></tbody>
            </table>
          </section>
        </section>
      `);
      ...
      detailChunks.forEach((rowsChunk) => {
        const chunkRows = rowsChunk.map((t) => `
          <tr class="${t?.isOverdue ? "is-overdue" : t?.status === "Open" ? "is-open" : ""}">
            ...
            <td>${t?.completedAt ? escapeHtml(formatDateTime(t.completedAt)) : "—"}</td>
        ...
        pages.push(`
          <section class="pdf-page">
            <section class="section compact-top">
              ...
              <table>
                <thead>
                  <tr><th>Title</th><th>Type</th><th>Status</th><th>Overdue Open</th><th>Was Delayed</th><th>Completed At</th><th>Due</th><th>Lead Code</th><th>Prospect</th><th>Lead Status</th></tr>
                </thead>
