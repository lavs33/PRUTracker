                  ...
                  <>
                    ...
                    <div className="manager-table-wrap">
                      <table className="manager-table manager-table--promotion-history">
                        <thead>
                          <tr><th>Agent Code</th><th>Agent Name</th><th>Agent Type</th><th>Status</th><th>{reassignmentMonthLabel} Done Approaches</th><th>{reassignmentMonthLabel} Approach Target</th><th>Open Approach Tasks Due {reassignmentMonthLabel}</th><th>Projected {reassignmentMonthLabel} Approaches</th><th>{reassignmentMonthLabel} Closing Ratio</th><th>{reassignmentMonthLabel} Closing Ratio Target</th><th>{reassignmentMonthLabel} Active Policies</th><th>{reassignmentMonthLabel} Active Policy Target</th><th>Select</th>{selectedUmAffectedClient.reassigned === true && <th>Reassignment Date and Time</th>}</tr>
                        </thead>
                        <tbody>
                          {displayedReassignmentAgentRows.map((agent) => (
                            <tr key={agent.id}>
                              ...
                              <td>{agent.reassignmentMetrics.completedApproaches}</td>
                              <td>{agent.reassignmentMetrics.monthlyDoneApproachesTarget}</td>
                              <td>{agent.reassignmentMetrics.openApproachTasks}</td>
                              <td>{agent.reassignmentMetrics.projectedApproaches}</td>
                              <td>{agent.reassignmentMetrics.closingRatio}%</td>
                              <td>{agent.reassignmentMetrics.monthlyClosingRatioTarget}%</td>
                              <td>{agent.reassignmentMetrics.activePolicies}</td>
                              <td>{agent.reassignmentMetrics.monthlyActivePoliciesTarget}</td>
