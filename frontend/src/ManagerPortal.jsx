      ...
      return [...branchKpiUnitRows]
        ...
        .map((unit) => {
          ...
          return {
            ...
            kpiKey: kpi.key,
            kpiLabel: dependsOnUnitSalesProduction ? "Unit Sales Production KPI" : formatKpiLabel(kpi, "BRANCH"),
            ...
            requiredTargetLabel: dependsOnUnitSalesProduction && branchUnitSalesTargetDetails.qualifier
              ? formatActualKpiValue(branchUnitSalesTarget, recommendationValueType)
