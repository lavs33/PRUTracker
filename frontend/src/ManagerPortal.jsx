        ...
        <main className="manager-portal__content">
            ...
            <section className="manager-panel">
              <div className="manager-panel__head">
                <div>
                  ...
                  <p>
                    {normalizedRole === "BM"
                      ? "Assign or unassign KPI cards and edit count/range/default targets for branch, unit, and agent scopes."
                      : "View KPI assignments for your manager scope."}
                  </p>
                </div>
              </div>
          ...
          {!isLoading && !loadError && activeView === "kpi_progress" && (
            <section className="manager-panel">
              <div className="manager-panel__head">
                <div>
                  <h2>KPI Progress Dashboard</h2>
                  <p>View assigned KPI targets for your role level. Progress values can be wired to production analytics as the KPI tracking engine matures.</p>
                </div>
              </div>
