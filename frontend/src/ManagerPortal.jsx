...
function ManagerPortal({ roleType }) {
  ...
  const unitBranchSalesContribution = useMemo(() => {
    ...
    return {
      ...
      branchActual,
      contributionShare,
      comparison: getKpiComparison(unitActual, branchKpiForPeriod),
  ...
  const generateUnitKpiPdfReport = () => {
    ...
    createPrintableReport({
      ...
      analyticsSections: unitBranchSalesContribution ? [
        {
          title: "Contribution in Branch Sales Production",
          rows: [
            { label: "Unit Sales Production", value: formatMoney(unitBranchSalesContribution.actual) },
            { label: "Branch Sales Production", value: formatMoney(unitBranchSalesContribution.branchActual) },
            { label: "Contribution Share", value: `${unitBranchSalesContribution.contributionShare}%` },
            { label: "Branch KPI Target", value: formatKpiTarget(unitBranchSalesContribution.kpi) },
          ],
        },
      ] : [],
      tableSections: [
                  ...
                  <div className="manager-kpi-unit-drilldown">
                    ...
                    <div className="manager-kpi-progress-grid">
                      <article className={`manager-kpi-progress-card ${unitBranchSalesContribution.comparison.className}`}>
                        ...
                        <div className="manager-kpi-progress-bar" aria-label={`Unit contribution progress ${unitBranchSalesContribution.comparison.percent}%`}>
