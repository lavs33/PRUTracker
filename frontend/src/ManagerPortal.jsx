                ...
                {orphanAgentAction ? (
                  <div className="manager-orphan-action-page">
                    ...
                    {orphanAgentAction === "long_leave" && (
                      <div className="manager-orphan-action-form">
                        <label>
                          ...
                          <input type="date" min={todayDateInputValue} value={orphanLeaveStartDate} onChange={(e) => setOrphanLeaveStartDate(e.target.value)} />
                        </label>
                        <label>
                          <span>Leave End Date</span>
                          <input type="date" min={orphanLeaveStartDate || todayDateInputValue} value={orphanLeaveEndDate} onChange={(e) => setOrphanLeaveEndDate(e.target.value)} />
                    ...
                    <div className="manager-orphan-action-buttons">
                      ...
                      <button type="button" className="manager-refresh-btn" disabled={orphanAgentAction === "long_leave" && Boolean(orphanLeaveEndDateError)}>
