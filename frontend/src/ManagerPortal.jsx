      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .pdf-page { min-height: ${pageHeight}; margin: 10mm 8mm 12mm; padding: 4mm 2mm 10mm; position: relative; page-break-after: always; overflow: visible; }
          ...
          .pdf-footer { position: static; margin-top: 8mm; padding-top: 6px; border-top: 1px solid #d6dee8; display: flex; justify-content: space-between; font-size: 9px; break-inside: avoid; page-break-inside: avoid; }
        </style>
      </head>
      <body>
        ${firstPage}
