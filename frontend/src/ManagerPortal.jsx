...
function ManagerPortal({ roleType }) {
  ...
  const goToNextLongLeaveStep = () => {
    if (orphanLongLeaveStep === 1 && !validateLongLeaveDetails()) return;
                    ...
                    <div className="manager-orphan-action-buttons">
                      ...
                      {orphanAgentAction === "long_leave" && orphanLongLeaveStep < 3 ? (
                        <button
                          type="button"
                          className="manager-refresh-btn"
                          disabled={orphanLongLeaveStep === 1 ? Boolean(orphanLeaveEndDateError) : !confirmOrphanTransfer}
