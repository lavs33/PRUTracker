...
function createPrintableReport({
  ...
  const tablePages = tableSections.map((section) => {
    ...
    return {
      ...
      compactWithPrevious: Boolean(section.compactWithPrevious),
  ...
  const reportFooter = `
    <footer class="pdf-footer">
      ...
      <span>Page <span class="pdf-page-number"></span> of <span class="pdf-page-count"></span></span>
    </footer>
  `;
      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .pdf-page { margin: 0; padding: 12mm 8mm 18mm; position: relative; page-break-after: always; overflow: visible; }
          ...
          .pdf-table-top-spacer th { height: 7mm; padding: 0; border: 0; background: transparent; }
          .pdf-table-bottom-spacer td { height: 16mm; padding: 0; border: 0; background: transparent; }
          .empty-row { text-align: center; color: #6b7280; }
          .pdf-footer { position: fixed; left: 8mm; right: 8mm; bottom: 4mm; padding-top: 6px; border-top: 1px solid #d6dee8; display: flex; justify-content: space-between; font-size: 9px; break-inside: avoid; page-break-inside: avoid; }
          .pdf-page-number::before { content: counter(page); }
          .pdf-page-count::before { content: counter(pages); }
        </style>
      </head>
      <body>
        ${firstPage}
