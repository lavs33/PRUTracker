...
function ManagerPortal({ roleType }) {
  ...
  const generateKpiPdfReport = () => {
    ...
    createPrintableReport({
      ...
      statCards: [
        { label: "Sales Production", value: formatMoney(salesProductionActual), tone: "red" },
        { label: "Target Achievement", value: `${targetAchievementActual}%`, tone: "gold" },
        ...
        <main className="manager-portal__content">
          {activeView === "dashboard" && <section className="manager-hero">
            <div>
              ...
              <h1>{normalizedRole === "BM" ? `${scope.branchName || "Branch"} Branch` : getPortalHeading(normalizedRole)}</h1>
              <p>
                {normalizedRole === "BM"
