              ...
              <section className="manager-panel">
                ...
                <section className="manager-unit-details-card">
                  <div>
                    ...
                    <div className="manager-unit-details-grid">
                      <span>Unit Manager Code</span><strong>{selectedUnit?.manager?.code || "—"}</strong>
                      <span>Unit Manager Name</span><strong>{selectedUnit?.manager?.name || "—"}</strong>
                      <span>Assistant Unit Manager Code</span><strong>{selectedUnit?.assistantManager?.code || "—"}</strong>
                      <span>Assistant Unit Manager Name</span><strong>{selectedUnit?.assistantManager?.name || "—"}</strong>
                    </div>
                  </div>
                ...
                <div className="manager-agent-detail-grid manager-agent-detail-grid--single">
                  {unitPerformanceTab === "clients" && (
                    <article>
                      <h3>Clients Performance</h3>
                      <span>Total Prospects</span><strong>{selectedUnitSummary.totalProspects}</strong>
                      <span>Active Prospects</span><strong>{selectedUnitSummary.activeProspects}</strong>
                      <span>Total Leads</span><strong>{selectedUnitSummary.leads}</strong>
                      ...
                      <span>At Risk Policyholders</span><strong>{selectedUnitSummary.atRiskPolicies}</strong>
                      <span>Lapsed Policies</span><strong>{selectedUnitSummary.lapsedPolicies}</strong>
                    </article>
                  )}
                  {unitPerformanceTab === "tasks" && (
                    <article>
                      ...
                      <span>Delayed Done</span><strong>{selectedUnitSummary.delayedDoneTasks}</strong>
