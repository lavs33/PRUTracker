                      ...
                      {draftKpis.map((kpi) => {
                        ...
                        return (
                          <div className={`manager-kpi-edit-row ${isEditing ? "editing" : ""} ${isExpanded ? "expanded" : ""}`} key={kpi.key}>
                              ...
                              <div className="manager-kpi-row-actions">
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    if (!nextAssigned) {
                                      const unassignedKpi = buildUnassignedKpiDraft(kpi);
                                      updateKpiDraft(assignment, kpi.key, "assigned", false);
                                      setKpiFieldErrors((current) => ({ ...current, [rowKey]: {} }));
                                      setEditingKpiKey("");
                                      setExpandedKpiKey("");
                                      saveKpi(assignment, kpi.key, unassignedKpi);
                                      return;
                                    }
                                    updateKpiDraft(assignment, kpi.key, "assigned", true);
                            ...
                            {isExpanded && kpi.assigned !== false ? <div className="manager-kpi-frequency-grid">
