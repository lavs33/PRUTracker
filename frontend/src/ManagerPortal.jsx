...
function ManagerPortal({ roleType }) {
  ...
  const orphanAgentRows = useMemo(() => {
    const searchedAgents = buildFilter(portalData?.agents || [], orphanAgentSearch, ["username", "name", "agentType", "unit", "status"]);
    ...
    const sorters = {
      ...
      agentTypeAsc: (left, right) => compareText(left, right, "agentType"),
      agentTypeDesc: (left, right) => compareText(left, right, "agentType") * -1,
      statusAsc: (left, right) => compareText(left, right, "status"),
      statusDesc: (left, right) => compareText(left, right, "status") * -1,
      unitAsc: (left, right) => compareText(left, right, "unit"),
      unitDesc: (left, right) => compareText(left, right, "unit") * -1,
            ...
            selectedAgent ? (
              ...
              <section className="manager-panel">
                ...
                <div className="manager-toolbar manager-toolbar--orphan">
                  <div className="manager-toolbar__filters">
                    <label className="manager-search" htmlFor="manager-orphan-agent-search">
                      <FaSearch size={14} />
                      <input
                        id="manager-orphan-agent-search"
                        type="search"
                        placeholder="Search by username, agent name, type, unit, or status"
                        value={orphanAgentSearch}
                        onChange={(e) => setOrphanAgentSearch(e.target.value)}
                      />
                    </label>
                    <label className="manager-select" htmlFor="manager-orphan-agent-type-filter">
                    ...
                    <label className="manager-select" htmlFor="manager-orphan-unit-filter">
                      <span>Unit Name</span>
                    ...
                    <label className="manager-select" htmlFor="manager-orphan-status-filter">
                    ...
                    <label className="manager-select" htmlFor="manager-orphan-sort">
                      <span>Sort By</span>
                      <select id="manager-orphan-sort" value={orphanAgentSort} onChange={(e) => setOrphanAgentSort(e.target.value)}>
                        ...
                        <option value="agentTypeAsc">Agent Type (A → Z)</option>
                        <option value="agentTypeDesc">Agent Type (Z → A)</option>
                        <option value="statusAsc">Agent Status (A → Z)</option>
                        <option value="statusDesc">Agent Status (Z → A)</option>
                        <option value="unitAsc">Unit Name (A → Z)</option>
                        <option value="unitDesc">Unit Name (Z → A)</option>
