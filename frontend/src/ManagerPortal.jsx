  ...
  reportDoc.write(`
    ...
    <html>
      <head>
        ...
        <style>
          @page { size: ${pageSize}; margin: 12mm 8mm 18mm; }
          * { box-sizing: border-box; }
          body { margin: 0; font-family: Verdana, Geneva, sans-serif; color: #0f172a; }
          .pdf-page { margin: 0; padding: 4mm 2mm 2mm; position: relative; page-break-after: always; overflow: visible; }
          ...
          .pdf-footer { position: fixed; left: 0; right: 0; bottom: -12mm; padding-top: 6px; border-top: 1px solid #d6dee8; display: flex; justify-content: space-between; font-size: 9px; break-inside: avoid; page-break-inside: avoid; }
