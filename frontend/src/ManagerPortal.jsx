            ...
            <section className="manager-panel">
              ...
              <div className="manager-tab-row manager-orphan-endorsement-tabs">
                <div className="manager-tab-buttons">
                  <button type="button" className={orphanEndorsementTab === "long_leaves" ? "active" : ""} onClick={() => { setSelectedUmLongLeaveRecordId(""); setOrphanEndorsementTab("long_leaves"); }}>From Long Leaves</button>
                  <button type="button" className={orphanEndorsementTab === "retirements" ? "active" : ""} onClick={() => { setSelectedUmLongLeaveRecordId(""); setOrphanEndorsementTab("retirements"); }}>From Retirements</button>
                </div>
              </div>
                      ...
                      <table className="manager-table manager-table--promotion-history">
                        ...
                        <tbody>
                          {selectedUmLongLeaveRecord.affectedProspects.map((prospect) => (
                            <tr key={prospect.id || `${prospect.prospectCode}:${prospect.leadCode}`}>
                      ...
                      <table className="manager-table manager-table--promotion-history">
                        ...
                        <tbody>
                          {selectedUmLongLeaveRecord.affectedPolicyholders.map((policyholder) => (
                            <tr key={policyholder.id || `${policyholder.policyholderCode}:${policyholder.policyNumber}`}>
