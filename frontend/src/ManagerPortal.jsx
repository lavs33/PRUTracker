                  ...
                  <>
                    ...
                    <div className="manager-table-wrap">
                      <table className="manager-table manager-table--promotion-history">
                        <thead>
                          <tr><th>Agent Code</th><th>Agent Name</th><th>Agent Type</th><th>Status</th><th>{reassignmentMonthLabel} Done Approaches</th><th>{reassignmentMonthLabel} Approach Target</th><th>Open Approach Tasks Due {reassignmentMonthLabel}</th><th>Projected Monthly Approaches</th><th>Monthly Closing Ratio</th><th>Monthly Closing Ratio Target</th><th>Monthly Active Policies</th><th>Monthly Active Policy Target</th><th>Select</th>{selectedUmAffectedClient.reassigned === true && <th>Reassignment Date and Time</th>}</tr>
                        </thead>
                        <tbody>
