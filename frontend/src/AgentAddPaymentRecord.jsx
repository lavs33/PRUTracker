                ...
                <form className="addpay-form" onSubmit={handleSubmit}>
                  <label className="addpay-field">
                    ...
                    <input
                      ...
                      readOnly
                    />
                    {isMissedPaymentRecord ? <small>Computed for the covered payment periods: {paymentPeriodLabel || "—"}. This includes {missedPaymentPeriod.count || 1} payment period(s), plus any overdue fee.</small> : null}
