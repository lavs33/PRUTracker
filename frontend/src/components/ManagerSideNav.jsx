import { FaBars, FaBullseye, FaChartLine, FaChevronLeft, FaChevronRight, FaHome, FaTasks, FaUsers } from "react-icons/fa";
...
const NAV_ITEMS = [
  ...
  { key: "kpi_progress", label: "Branch KPI Progress", icon: <FaBullseye size={18} /> },
];
