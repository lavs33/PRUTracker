import { FaBars, FaBullseye, FaChevronLeft, FaChevronRight, FaHome, FaSignal, FaUserCircle, FaUsers } from "react-icons/fa";
...
const NAV_ITEMS = [
  ...
  { key: "profile", label: "Profile", icon: <FaUserCircle size={18} /> },
];
