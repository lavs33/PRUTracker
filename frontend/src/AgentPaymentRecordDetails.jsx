...
function AgentPaymentRecordDetails() {
  ...
  const transferRows = [
    ...
    ["Payment Period Start", formatDateOnly(payment?.paymentPeriod?.startDate)],
    ["Payment Period End", formatDateOnly(payment?.paymentPeriod?.endDate)],
    ["Payment Period Covered", payment.paymentPeriodLabel || "—"],
    ["Method", payment.methodForPayment || "—"],
    ["Proof MIME Type", payment.proofOfPaymentFileMimeType || "—"],
  ...
  const eorRows = [
    ...
    ["eOR MIME Type", payment.eorFileMimeType || "—"],
