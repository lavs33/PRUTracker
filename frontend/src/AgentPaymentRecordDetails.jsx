...
function AgentPaymentRecordDetails() {
  ...
  const handleEditPaymentSection = () => {
    if (prospect._id && lead._id) {
      navigate(`/agent/${user.username}/prospects/${prospect._id}/leads/${lead._id}/engage`);
    }
  };
                ...
                <div className="pay-detailGrid">
                  <section className="pay-detailCard">
                    <div className="pay-detailCardHeader">
                      ...
                      <button type="button" className="pay-editButton" onClick={handleEditPaymentSection}>Edit</button>
                    </div>
