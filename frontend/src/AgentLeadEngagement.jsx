                      ...
                      <div className="le-block">
                        ...
                        {hasSavedApplicationAttendance ? (
                          <>
                            ...
                            {applicationAttendanceForm.attendedAt ? (
                              <div className="le-formRow">
                                <label className="le-label">Recorded At</label>
                                <p className="le-smallNote">{formatDateTime(applicationAttendanceForm.attendedAt)}</p>
                              </div>
                            ) : null}
                            ...
                            <div className="le-formRow" style={{ marginTop: 10 }}>
                              <h4 className="le-blockTitle" style={{ margin: 0 }}>Record Premium Payment Transfer</h4>
                            </div>
                          </>
                        ) : (
                          <>
