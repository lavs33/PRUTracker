            ...
            <>
              ...
              <div className="le-mainRow">
                <section className="le-card">
                  ...
                  {showPolicyIssuancePanel && (
                    <div className="le-block">
                      <h4 className="le-blockTitle">Policy Issuance</h4>
                      <p className="le-smallNote" style={{ marginTop: 6 }}>
                        Current activity: <strong>{policyIssuanceUiActivityKey}</strong>
                      </p>
                      <p className="le-muted" style={{ marginTop: 8 }}>
                        Policy Issuance activity badges are now enabled for: Record Policy Application Status, Upload Policy Summary, and Record Coverage Duration Details.
                      </p>
                    </div>
                  )}
