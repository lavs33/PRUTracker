                  ...
                  {showContactingTracker && (
                    ...
                    <>
                      <div className="le-block">
                        <div className="le-formGrid two" style={{ marginBottom: 8 }}>
                      ...
                      <div className="le-block">
                        ...
                        {applicationAttendanceForm.attendanceChoice === "NO" ? (
                          <p className="le-smallNote" style={{ color: "#DA291C", marginTop: 6 }}>
                            Prospect attendance is required before proceeding to application submission.
                          </p>
                        ) : null}
                        ...
                        {applicationAttendanceForm.attendanceChoice === "YES" ? (
                          <>
                            ...
                            {String(applicationAttendanceForm.attendanceProofImageDataUrl || "").trim() ? (
                              ...
                              <p className="le-smallNote" style={{ color: "#DA291C", marginTop: 6 }}>
                                Proof of Attendance (JPG, JPEG, PNG) is required before proceeding to application submission.
                              </p>
                            )}
                          </>
                        ) : null}
