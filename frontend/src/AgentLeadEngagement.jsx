  ...
  const submitApplicationPremiumPaymentTransfer = async () => {
    try {
      ...
      if (totalAnnualPremiumPhp === null) {
        setApplicationPremiumPaymentFieldErrors({ totalAnnualPremiumPhp: "Total annual premium is required." });
        return;
      }
      if (totalFrequencyPremiumPhp === null) {
        setApplicationPremiumPaymentFieldErrors({ totalFrequencyPremiumPhp: "Total requested-frequency premium is required." });
        return;
      }
      ...
      if (!paymentProofImageDataUrl) {
        setApplicationPremiumPaymentFieldErrors({ paymentProofImageDataUrl: "Proof of payment image is required." });
        return;
      }
                              ...
                              <div className="le-formRow">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setApplicationPremiumPaymentFieldErrors((prev) => ({ ...prev, totalAnnualPremiumPhp: "" }));
                                  }}
