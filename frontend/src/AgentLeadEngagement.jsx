                            ...
                            {proposalMeetingSaved ? (
                              <>
                                <p className="le-smallNote" style={{ color: "#0f766e" }}>
                                  Proposal presentation schedule saved.
                                </p>
                                <div className="le-attemptMeta" style={{ marginTop: 8 }}>
                                  {proposalMeetingSaved?.startAt ? <div><span className="le-metaLabel">Start</span><span className="le-metaValue">{formatDateTime(proposalMeetingSaved.startAt)}</span></div> : null}
                                  {proposalMeetingSaved?.endAt ? <div><span className="le-metaLabel">End</span><span className="le-metaValue">{formatDateTime(proposalMeetingSaved.endAt)}</span></div> : null}
                                  {proposalMeetingSaved?.durationMin ? <div><span className="le-metaLabel">Duration</span><span className="le-metaValue">{proposalMeetingSaved.durationMin} mins</span></div> : null}
                                  ...
                                  {proposalMeetingSaved?.platform ? <div><span className="le-metaLabel">Platform</span><span className="le-metaValue">{proposalMeetingSaved.platform}</span></div> : null}
                                  {proposalMeetingSaved?.platformOther ? <div><span className="le-metaLabel">Other Platform</span><span className="le-metaValue">{proposalMeetingSaved.platformOther}</span></div> : null}
                                  ...
                                  <div><span className="le-metaLabel">Invite Sent</span><span className="le-metaValue">{proposalMeetingSaved?.inviteSent ? "Yes" : "No"}</span></div>
