                  ...
                  {showNeedsAssessmentPanel && (
                    <>
                      ...
                      {showProposalSchedulingSection && isNeedsScheduleViewed && (
                          <div className="le-block" style={{ marginTop: 16 }}>
                            <div className="le-inlineActionRow">
                              <h4 className="le-blockTitle" style={{ fontSize: 16 }}>Schedule Follow-up Needs Assessment Meet</h4>
                            </div>
                            <div className="le-formRow">
                            ...
                            <div className="le-actions">
                              <button
                                type="button"
                                className="le-btn primary"
                                onClick={() => setNeedsFollowUpDecisionSaved(Boolean(needsFollowUpRequired))}
                                disabled={!needsFollowUpRequired}
                              >
                            ...
                            {needsFollowUpDecisionSaved && needsFollowUpRequired === "YES" ? (
                              <p className="le-smallNote" style={{ marginTop: 8 }}>
                                Follow-up needs assessment is required. Save the follow-up meeting details below. Proposal presentation scheduling will remain locked until this is completed.
                              </p>
                            ) : null}
                          </div>
                      )}
