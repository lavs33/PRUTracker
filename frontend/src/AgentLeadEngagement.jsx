                        ...
                        <div className="le-block">
                          ...
                          {addNewNeedsMeetingMode ? (
                            <p className="le-smallNote" style={{ marginTop: 8 }}>
                              This creates an additional follow-up Needs Assessment meeting and leaves the previous meeting in history. Use Reschedule Meeting only when changing the current meeting time/details.
                            </p>
                          ) : rescheduleFollowUpNeedsMeetingMode || rescheduleFromNeedsMode || contactingRescheduleMode ? (
                            <p className="le-smallNote" style={{ marginTop: 8 }}>
