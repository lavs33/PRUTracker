...
function AgentLeadEngagement() {
  ...
  const isApplicationAttendanceProofEditable = canRequestApplicationAttendanceProofEdit || applicationAttendanceProofEditMode;
                        ...
                        <div className="le-block">
                          ...
                          {displayedHasSavedApplicationAttendance ? (
                            <>
                              ...
                              {canRequestApplicationAttendanceProofEdit ? (
