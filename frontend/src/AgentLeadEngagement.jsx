                  ...
                  {showContactingPanel && !showAddAttempt && isValidateContactViewed && isEngagementBlocked && (
                      ...
                      {showProposalPanel && isProposalPresentationViewed ? (
                        <div className="le-block">
                          ...
                          {!proposalPresentationDecisionEditMode && (proposalPresentationFurtherPromptSaved || proposalPresentationForm.proposalAccepted === "NO") && hasPendingFurtherProposalMeetingSchedule ? (
                      ...
                      {showProposalPanel &&
                      !isProposalPresentationViewed &&
                      !proposalPresentationDecisionEditMode &&
                      (proposalPresentationFurtherPromptSaved || proposalPresentationForm.proposalAccepted === "NO") &&
                      hasPendingFurtherProposalMeetingSchedule ? (
                        <p className="le-muted le-presentationFurtherPrompt" style={{ marginTop: 8 }}>
                          Further Proposal Presentation can be scheduled.{" "}
                          <button
                            type="button"
                            className="le-btn ghost"
