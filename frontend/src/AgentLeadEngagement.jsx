...
function AgentLeadEngagement() {
  ...
  const startRescheduleProposalPresentation = () => {
    ...
    setProposalMeetingFieldErrors({});
    setProposalMeetingForm({
      meetingDate: toDateInputValue(proposalMeetingSaved.startAt),
      meetingStartTime: `${String(new Date(proposalMeetingSaved.startAt).getHours()).padStart(2, "0")}:${String(new Date(proposalMeetingSaved.startAt).getMinutes()).padStart(2, "0")}`,
