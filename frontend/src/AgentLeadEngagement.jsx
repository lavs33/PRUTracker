...
function AgentLeadEngagement() {
  ...
  const RISK_CATEGORY_RANGES = useMemo(
    () => ({
      NOT_RECOMMENDED: "0 - 5",
      CONSERVATIVE: "6 - 9",
      MODERATE: "10 - 15",
                            ...
                            <>
                              ...
                              {needsPrioritiesDerived.priority === "Investment" && (
                                <>
                                  ...
                                  <p className="le-muted" style={{ marginTop: 4, whiteSpace: "pre-line" }}>
                                    {needsPrioritiesDerived.riskProfileCategory
                                      ? `${RISK_CATEGORY_RANGES[needsPrioritiesDerived.riskProfileCategory]} - ${RISK_CATEGORY_LABELS[needsPrioritiesDerived.riskProfileCategory]}

${RISK_CATEGORY_NOTES[needsPrioritiesDerived.riskProfileCategory] || ""}`
                                      : ""}
                                  </p>
