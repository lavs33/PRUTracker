...
function AgentLeadEngagement() {
  ...
  const onSaveNeedsAssessment = async () => {
    ...
    if (currentPriorityCheck === "Protection") {
      ...
      if (monthlySpend === null) aggregateFieldErrors.protectionMonthlySpend = "Protection: approximate monthly spend is required.";
      ...
      if (savingsForProtection === null) aggregateFieldErrors.protectionSavings = "Protection: savings for protection is required.";
    }
    ...
    if (currentPriorityCheck === "Health") {
      ...
      if (amountToCoverCriticalIllness === null) aggregateFieldErrors.healthAmount = "Health: approximate amount to cover critical illness is required.";
      if (savingsForCriticalIllness === null) aggregateFieldErrors.healthSavings = "Health: savings for critical illness is required.";
  ...
  useEffect(() => {
    ...
    if (currentPriority === "Protection") {
      const monthlySpend = toNonNegativeNumber(npCheck?.protection?.monthlySpend);
      const savingsForProtection = toNonNegativeNumber(npCheck?.protection?.savingsForProtection);
      if (monthlySpend === null && needsSaveAttempted) aggregateFieldErrors.protectionMonthlySpend = "Protection: approximate monthly spend is required.";
      ...
      if (savingsForProtection === null && needsSaveAttempted) aggregateFieldErrors.protectionSavings = "Protection: savings for protection is required.";
    }

    if (currentPriority === "Health") {
      const amountToCoverCriticalIllness = toNonNegativeNumber(npCheck?.health?.amountToCoverCriticalIllness);
      const savingsForCriticalIllness = toNonNegativeNumber(npCheck?.health?.savingsForCriticalIllness);
      if (amountToCoverCriticalIllness === null && needsSaveAttempted) aggregateFieldErrors.healthAmount = "Health: approximate amount to cover critical illness is required.";
      if (savingsForCriticalIllness === null && needsSaveAttempted) aggregateFieldErrors.healthSavings = "Health: savings for critical illness is required.";
      else if (amountToCoverCriticalIllness !== null && savingsForCriticalIllness > amountToCoverCriticalIllness) aggregateFieldErrors.healthSavings = "Health: savings for critical illness cannot be higher than amount to cover critical illness.";
    }
