                          ...
                          <div className="le-block" style={{ marginTop: 16 }}>
                            ...
                            <div className="le-formRow">
                              ...
                              <select
                                ...
                                onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingDurationMin: Number(e.target.value) }))}
                                disabled={savingProposalMeeting}
                              >
                                <option value={30}>30 mins</option>
                                <option value={60}>60 mins</option>
                            ...
                            <div className="le-formRow">
                              ...
                              <select
                                ...
                                onChange={(e) => setProposalMeetingForm((f) => ({
                                  ...f,
                                  meetingMode: e.target.value,
                                  meetingPlatform: "",
                                  meetingPlatformOther: "",
                              ...
                              <>
                                <div className="le-formRow">
                                  ...
                                  <select
                                    ...
                                    onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingPlatform: e.target.value }))}
                                    disabled={savingProposalMeeting}
                                  >
                                    <option value="">Select</option>
                                    <option value="Zoom">Zoom</option>
                                ...
                                {proposalMeetingForm.meetingPlatform === "Other" && (
                                  <div className="le-formRow">
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingPlatformOther: e.target.value }))}
                                      disabled={savingProposalMeeting}
                                    />
                                  </div>
                                )}
                                <div className="le-formRow">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingLink: e.target.value }))}
                                    placeholder="https://..."
                                    disabled={savingProposalMeeting}
                                  />
                                </div>
                                <div className="le-formRow">
                                  <label className="le-check">
                                    <input
                                      ...
                                      onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingInviteSent: e.target.checked }))}
                                      disabled={savingProposalMeeting}
                                    />
                                    <span>I confirm invite link has been sent (required)</span>
                                  </label>
                            ...
                            {proposalMeetingForm.meetingMode === "Face-to-face" && (
                              <div className="le-formRow">
                                ...
                                <input
                                  ...
                                  onChange={(e) => setProposalMeetingForm((f) => ({ ...f, meetingPlace: e.target.value }))}
                                  disabled={savingProposalMeeting}
                                />
                              </div>
                            )}
