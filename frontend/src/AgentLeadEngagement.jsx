...
function AgentLeadEngagement() {
  ...
  useEffect(() => {
    if (!showNeedsAssessmentPanel || isHistoryView) return;
    if (stage !== "Proposal" || !isViewingPastStage) return;
    if (needsAssessmentViewedActivityKey !== "Record Prospect Attendance") return;
    setNeedsAssessmentViewedActivityKey("Perform Needs Analysis");
  }, [isHistoryView, isViewingPastStage, needsAssessmentViewedActivityKey, showNeedsAssessmentPanel, stage]);
