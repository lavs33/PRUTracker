                      ...
                      {!isHistoryView && isNeedsAnalysisViewed && needsAnalysisEditMode && needsAssessmentForm.attendanceChoice === "YES" && String(needsAssessmentForm.attendanceProofImageDataUrl || "").trim() && (
                        <div className="le-block">
                          ...
                          <div className="le-blockHeader withTopBorder">
                              ...
                              <div className="le-blockHeader withTopBorder" style={{ background: "linear-gradient(90deg, #fff5f4 0%, #ffffff 100%)", borderRadius: 10, padding: "10px 12px", border: "1px solid #f3d4d0" }}>
                                <h4 className="le-blockTitle">Riders & Premium Payment</h4>
                                <button
                                  type="button"
                                  className="le-btn secondary"
                                  style={{ minWidth: 44, fontWeight: 700, borderRadius: 999, padding: "6px 12px" }}
                              ...
                              <div className="le-blockHeader withTopBorder" style={{ background: "linear-gradient(90deg, #f8fbff 0%, #ffffff 100%)", borderRadius: 10, padding: "10px 12px", border: "1px solid #dbe7ff" }}>
                                <h4 className="le-blockTitle">Notes (Optional)</h4>
                                <button type="button" className="le-btn secondary" style={{ minWidth: 44, fontWeight: 700, borderRadius: 999, padding: "6px 12px" }} onClick={() => setNeedsSectionOpen((s) => ({ ...s, productRidersNotes: !s.productRidersNotes }))}>
                                  {needsSectionOpen.productRidersNotes ? "Collapse ▴" : "Expand ▾"}
                                </button>
                              </div>
