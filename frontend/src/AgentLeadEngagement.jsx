                ...
                <section className="le-card">
                  ...
                  {showContactingPanel && (
                    <>
                      ...
                      {showProposalPanel && (
                        <div className="le-block">
                          <h4 className="le-blockTitle">{proposalUiActivityKey === "Generate Proposal" ? "Generate Proposal" : "Saved Proposal Details"}</h4>
                            ...
                            <>
                              {String(proposalGenerateForm.proposalFileName || "").trim() ? (
                                <div className="le-formRow" style={{ marginTop: 10 }}>
                                  <label className="le-label">Proposal File</label>
                              ...
                              <div className="le-formRow">
                                <label className="le-label">Response</label>
                                <p className="le-smallNote">{proposalGenerateForm.sentToProspectEmail ? "Sent" : "Not sent"}</p>
                              </div>
                      ...
                      {showProposalPanel && proposalUiActivityKey !== "Generate Proposal" ? (
                        <div className="le-block">
                          <h4 className="le-blockTitle">Record Prospect Attendance</h4>
