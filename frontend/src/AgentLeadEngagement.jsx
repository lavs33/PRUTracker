                    ...
                    <>
                      ...
                      {showProposalPanel && (
                        <div className="le-block">
                          ...
                          {proposalUiActivityKey !== "Generate Proposal" ? (
                            <div className="le-attemptItem" style={{ marginTop: 12 }}>
                              <div className="le-attemptSectionHeader">Record Prospect Attendance</div>
                                ...
                                <div className="le-checkboxGrid">
                                  <label className="le-check">
                                    <input
                                      ...
                                      disabled={!isProposalEditableNow || proposalUiActivityKey !== "Record Prospect Attendance" || proposalAttendanceSaving}
                                    />
                                    <span>Yes</span>
                                  </label>
                                </div>
                              ...
                              {proposalAttendanceForm.attendanceChoice === "YES" ? (
                                <>
                                  ...
                                  {String(proposalAttendanceForm.attendanceProofImageDataUrl || "").trim() ? (
                                    <div className="le-formRow">
                                      <label className="le-label">Attendance Proof Preview</label>
                                      <img
                                        src={proposalAttendanceForm.attendanceProofImageDataUrl}
                                        alt="Proposal attendance proof preview"
                                        style={{ width: "100%", maxWidth: 520, border: "1px solid #e5e7eb", borderRadius: 10 }}
                                      />
                                    </div>
                                  ) : null}
                                </>
                              ...
                              {proposalUiActivityKey === "Record Prospect Attendance" && isProposalEditableNow ? (
                                <div className="le-actions">
                                  ...
                                  <button
                                    ...
                                    disabled={proposalAttendanceSaving}
                                  >
                                    {proposalAttendanceSaving ? "Saving..." : "Save Attendance"}
                                  </button>
                                </div>
                              ) : (
                                <div className="le-attemptMeta" style={{ marginTop: 8 }}>
                                  <div>
                                    <span className="le-metaLabel">Attendance Status</span>
                                    <span className="le-metaValue">{proposalAttendanceForm.attendanceChoice === "YES" ? "Recorded" : "Pending"}</span>
                                  </div>
                                  {proposalAttendanceForm.attendedAt ? (
                                    <div>
                                      <span className="le-metaLabel">Recorded At</span>
                                      <span className="le-metaValue">{formatDateTime(proposalAttendanceForm.attendedAt)}</span>
                                    </div>
                                  ) : null}
                                </div>
                              )}
