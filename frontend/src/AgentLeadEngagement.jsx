                        ...
                        <div className="le-block">
                          ...
                          {needsSectionOpen.needsPriorities && (
                            <>
                              ...
                              <div className="le-blockHeader withTopBorder">
                                <h5 className="le-attemptSectionHeader" style={{ marginTop: 0 }}>Product Selection *</h5>
                              ...
                              <div className="le-blockHeader withTopBorder">
                                <h5 className="le-attemptSectionHeader" style={{ marginTop: 0 }}>Optional Riders</h5>
                              ...
                              <div className="le-blockHeader withTopBorder">
                                <h5 className="le-attemptSectionHeader" style={{ marginTop: 0 }}>Notes (Optional)</h5>
