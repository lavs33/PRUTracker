...
function AgentLeadEngagement() {
  ...
  const hasNeedsAnalysisSaved = Boolean(String(needsAssessmentForm?.savedAt || needsAssessmentOutcomeActivity || "").trim());
                ...
                <section className="le-card">
                  ...
                  {showNeedsAssessmentPanel && (
                    <>
                      ...
                      {showProposalSchedulingSection && isNeedsScheduleViewed && (!isHistoryView || hasNeedsScheduleSaved) && needsFollowUpDecisionSaved && !needsFollowUpDecisionEditMode && savedNeedsFollowUpRequired === "NO" && (
                          <div className="le-block" style={{ marginTop: 16 }}>
