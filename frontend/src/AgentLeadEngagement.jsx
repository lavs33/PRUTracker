  ...
  const onSaveNeedsAssessment = async () => {
    ...
    if (String(npCheck.currentPriority || "").trim() === "Investment") {
      ...
      const profilerAnswered = [
        ...
        "capitalLossAffordability",
        "riskReturnTradeoff",
      ].every((k) => String(rp?.[k] || "").trim());
      if (!profilerAnswered) {
        aggregateFieldErrors.investmentRiskProfiler = "Investment Risk Profiler: please answer all survey questions.";
      }
      ...
      else if (fundMatch === "No" && !mismatchReason) aggregateFieldErrors.fundChoice = "Fund Choice: reason for mismatch is required when Fund Match is No.";
    }
