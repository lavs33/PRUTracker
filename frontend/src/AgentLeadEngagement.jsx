    ...
    <div className="le-shell">
      ...
      <div className="le-body">
        ...
        <main className="le-content">
          ...
          {!loading && !apiError && prospect && lead && engagement?.isBlocked && (
            <>
              ...
              <section className="le-card">
                <div className="le-cardHeader">
                  <h2 className="le-cardTitle">Lead Engagement</h2>
                  <button
                    type="button"
                ...
                <p className="le-muted" style={{ marginTop: 10 }}>
                  Update contact info to continue editing this lead engagement.
                </p>

                <div className="le-actions" style={{ justifyContent: "flex-start", marginTop: 14 }}>
                  <button type="button" className="le-btn secondary" onClick={goBackToLeadDetails}>
          ...
          {!loading && !apiError && prospect && lead && engagement && !engagement.isBlocked && (
            <>
              {/* Breadcrumb */}
              <div className="le-breadcrumb">
                <button
