...
function AgentLeadEngagement() {
  ...
  const handleNeedsNext = useCallback(() => {
    ...
    needsAssessmentViewedActivityKey,
    submitScheduleProposalPresentation,
  ]);

  const handleProposalNext = useCallback(() => {
  ...
  const handleApplicationNext = useCallback(() => {
    ...
    applicationViewedActivityKey,
  ]);

  const handlePolicyNext = useCallback(() => {
