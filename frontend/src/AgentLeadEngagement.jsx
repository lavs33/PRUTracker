                        ...
                        <div className="le-block">
                          ...
                          {hasSavedPolicyCoverageDetails ? (
                            <>
                              ...
                              {String(policyCoverageForm.coverageStartDate || "").trim() ? (
                                <div className="le-formRow">
                                  <label className="le-label">Coverage Start Date</label>
                                  <p className="le-smallNote">{policyCoverageForm.coverageStartDate}</p>
                                </div>
                              ) : null}
                            </>
                          ) : (
