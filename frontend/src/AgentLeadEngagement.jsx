...
function AgentLeadEngagement() {
  ...
  const onSaveNeedsAssessment = async () => {
    ...
    if (String(npCheck.currentPriority || "").trim() === "Investment") {
      ...
      else if (Math.abs(totalAllocation - 100) > 0.0001) aggregateFieldErrors.fundChoice = "Fund Choice: allocation in percentage must equal 100%.";
  ...
  useEffect(() => {
    ...
    if (currentPriority === "Investment") {
      ...
      else if (selectedFunds.length > 0 && Math.abs(totalAllocation - 100) > 0.0001) aggregateFieldErrors.fundChoice = "Fund Choice: allocation in percentage must equal 100%.";
      if (fundMatch === "No" && !mismatchReason && (needsSaveAttempted || selectedFunds.length > 0)) aggregateFieldErrors.mismatchReason = "Reason for mismatch is required.";
    }
                                ...
                                <>
                                  ...
                                  {needsPrioritiesDerived.fundMatch === "No" && (
                                    <>
                                      ...
                                      {renderNeedsAssessmentError("mismatchReason")}
                                    </>
                                  )}
                                </>
                              )}
