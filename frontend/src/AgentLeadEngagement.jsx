                ...
                <section className="le-card">
                  ...
                  {showContactingPanel && (
                    <>
                      ...
                      {showProposalPanel && ["Present Proposal", "Schedule Application Submission"].includes(proposalUiActivityKey) ? (
                        <div className="le-block">
                          <h4 className="le-blockTitle">{proposalUiActivityKey === "Present Proposal" ? "Present Proposal" : "Proposal Presentation"}</h4>
                            ...
                            <div className="le-checkboxGrid">
                              <label className="le-check">
                                <input
                                  ...
                                  disabled={!isProposalEditableNow || proposalUiActivityKey !== "Present Proposal" || proposalPresentationSaving}
                                />
                                <span>Yes</span>
                              </label>
                              <label className="le-check">
                          ...
                          {proposalUiActivityKey === "Present Proposal" && isProposalEditableNow ? (
                            <div className="le-actions">
                              <button
                                type="button"
                                className="le-btn secondary"
                      ...
                      {showProposalPanel && proposalUiActivityKey === "Schedule Application Submission" ? (
                        <div className="le-block">
                          <h4 className="le-blockTitle">Schedule Application Submission</h4>

                          <div className="le-formGrid two">
                            <div className="le-formRow">
                              <label className="le-label">Meeting Date *</label>
                              <input
                                type="date"
                                ...
                                onChange={(e) => {
                                  const v = e.target.value;
                                  setApplicationMeetingForm((f) => ({ ...f, meetingDate: v }));
                          ...
                          <div className="le-formRow">
                            <label className="le-label">Duration (minutes) *</label>
                            <select
                              className="le-input"
                              value={String(applicationMeetingForm.meetingDurationMin || 120)}
                              onChange={(e) => {
                                setApplicationMeetingForm((f) => ({ ...f, meetingDurationMin: Number(e.target.value) }));
                          ...
                          <div className="le-formRow">
                            ...
                            <div className="le-checkboxGrid">
                              {["Online", "Face-to-face"].map((mode) => (
                                <label className="le-check" key={`app-mode-${mode}`}>
                                  <input
                                    type="radio"
                                    name="app-meeting-mode"
                                    checked={applicationMeetingForm.meetingMode === mode}
                                    onChange={() => {
