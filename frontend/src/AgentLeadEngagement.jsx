...
function AgentLeadEngagement() {
  ...
  const resolveApproxIncome = (band, manualAmount) => {
                      ...
                      {needsAssessmentForm.attendanceChoice === "YES" && (
                        <div className="le-block">
                          <div className="le-blockHeader">
                            ...
                            >
                              {needsSectionOpen.basicInformation ? "Collapse" : "Expand"}
                            </button>
                          </div>
                          ...
                          <div className="le-blockHeader" style={{ marginTop: 16 }}>
                            <h5 className="le-attemptSectionHeader">Needs and Priorities</h5>
                            <button
                              type="button"
                              className="le-btn secondary"
                              onClick={() => setNeedsSectionOpen((s) => ({ ...s, needsPriorities: !s.needsPriorities }))}
                            >
                              {needsSectionOpen.needsPriorities ? "Collapse" : "Expand"}
                            </button>
                          </div>
                          ...
                          {meetingForm.meetingMode === "Online" && (
                            <>
                              <div className="le-formRow"><label className="le-label">Platform *</label><select className="le-input" value={meetingForm.meetingPlatform} onChange={(e) => setMeetingForm((f) => ({ ...f, meetingPlatform: e.target.value }))}><option value="">Select</option><option value="Zoom">Zoom</option><option value="Google Meet">Google Meet</option></select></div>
