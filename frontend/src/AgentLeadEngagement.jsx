...
function AgentLeadEngagement() {
  ...
  const needsActivityKeyRaw = String(currentActivityKeyRaw || "Record Prospect Attendance").trim();
                ...
                <section className="le-card">
                  ...
                  {showNeedsAssessmentPanel && (
                    <>
                      ...
                      {needsAssessmentForm.attendanceChoice === "YES" && needsActivityKeyRaw === "Record Prospect Attendance" && isNeedsAssessmentEditableNow && (
                      ...
                      {needsActivityKeyRaw !== "Record Prospect Attendance" && (
                        <div className="le-block">
                          ...
                          {isNeedsAssessmentEditableNow && needsActivityKeyRaw === "Perform Needs Analysis" && (
                          ...
                          {isNeedsAssessmentEditableNow && needsActivityKeyRaw === "Schedule Proposal Presentation" && (
                            <>
