...
const filterNotifications = (notifications, { typeFilter, priorityFilter, resolutionFilter, dateRange, ignorePriority = false }) => {
  ...
  return notifications.filter((notification) => (
    ...
    && (resolutionFilter === "all" || notificationResolution(notification) === resolutionFilter)
    ...
    <div className={`notif-row ${n.status === "Unread" ? "unread" : ""}`}>
      <div className="notif-left">
        <div className="notif-topline">
          ...
          <span className={`notif-resolution notif-resolution--${notificationResolution(n).toLowerCase().replaceAll(" ", "-")}`}>{notificationResolution(n)}</span>
          ...
          <div className="notifs-toolbar">
            ...
            <div className="notifs-filter">
              ...
              >
                ...
                <option value="Not Applicable">No Action Required</option>
              </select>
