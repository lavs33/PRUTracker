        ...
        {String(n.message || "").trim()
          ? (["ORPHAN_CLIENT_ASSIGNED", "ORPHAN_CLIENT_TRANSFERRED"].includes(String(n.type || "").toUpperCase())
            ...
            : (["UM_RECOMMENDATION", "AUM_RECOMMENDATION"].includes(String(n.type || "").toUpperCase())
              ? <div className="notif-agent-recommendation"><strong>Sales Production Recommendation</strong><p>{n.message}</p><small>Resolution is automatic once your contribution reaches the unit fair-share benchmark.</small></div>
