...
function AgentPolicyholderDetails() {
  ...
  const policySummaryFileName = String(policySummary.fileName || "PolicySummary.pdf").trim() || "PolicySummary.pdf";
                    ...
                    <div className="ph-previewModal">
                      <div className="ph-previewHeader">
                        <div>
                          ...
                          <p className="ph-previewSubtitle">
                            Policy Number: <strong>{policyholder.policyNumber || policySummary.policyNumber || "—"}</strong>
                          </p>
                        </div>
                        ...
                        <div className="ph-previewActions">
                          {policySummaryFileDataUrl ? (
                            <a
                              className="ph-downloadBtn"
                              href={policySummaryFileDataUrl}
                              download={policySummaryFileName}
                            >
                              Download
                            </a>
                          ) : null}
