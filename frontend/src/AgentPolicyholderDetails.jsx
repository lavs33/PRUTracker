              ...
              <>
                ...
                <section className="ph-records">
                  <div className="ph-recordsHeader">
                    ...
                    <button type="button" className="ph-actionBtn">
                      + New Payment
                    </button>
                  </div>
                  ...
                  <div className="ph-recordsBody">
                    <div className="ph-empty">
                      <div className="ph-emptyIcon">💳</div>
                      <div className="ph-emptyText">No payment records yet.</div>
                      <div className="ph-emptySubtext">Payment record UI is ready. Backend fetching can be connected later.</div>
                    </div>
                  </div>
                </section>
              </>
