            ...
            {activeSection === 'overview' && (
              <section className="aop-section aop-section-tight">
                <div className="aop-section-head">
                  ...
                  <p>Search the live hierarchy by area, branch, unit, or user and use the navigation on the left to open the setup forms you need.</p>
                </div>
                ...
                <div className="aop-toolbar">
                  <label className="aop-search" htmlFor="area-search">
                    ...
                    <input
                      id="area-search"
                      type="search"
                      placeholder="Search area, branch, unit, or user"
                      value={query}
