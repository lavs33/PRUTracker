                  ...
                  <div className="aop-form-grid">
                    {areaView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddArea}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" onClick={() => setAreaView('list')}>Back to All Areas</button>
                  ...
                  <div className="aop-form-grid">
                    {branchView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddBranch}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" onClick={() => setBranchView('list')}>Back to All Branches</button>
                  ...
                  <div className="aop-form-grid">
                    {unitView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddUnit}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" onClick={() => setUnitView('list')}>Back to All Units</button>
                ...
                {managerView === 'list' ? (
                  <>
                    ...
                    <div className="aop-list-toolbar">
                      ...
                      <div className="aop-toolbar-actions">
                        <button type="button" className="aop-action-btn" onClick={() => setManagerView('form')}>
                          Open Manager Reassignment
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="aop-form-grid">
                    ...
                    <button type="button" className="aop-close-btn" onClick={() => setManagerView('list')}>Back to All Managers</button>
              ...
              <section className="aop-section aop-section-tight">
                {agentView === 'list' ? (
                  ...
                  <div className="aop-form-grid">
                    ...
                    <button type="button" className="aop-close-btn" onClick={() => setAgentView('list')}>Back to All Agents</button>
