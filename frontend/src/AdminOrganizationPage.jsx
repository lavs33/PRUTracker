                ...
                {managerView === 'list' ? (
                  ...
                  <div className="aop-form-grid">
                    ...
                    {createManagerForm.managerType === 'AUM' ? (
                      <div className="aop-form-note">
                        AUM assignment is based on current-month sales performance. Only Active Full-Time agents who meet both their Active Policies and Closing Ratio KPI targets can be selected.
                      </div>
                    ) : null}
