...
function AdminOrganizationPage() {
  ...
  const fetchOrganizationTree = useCallback(async (areaSearch = query) => {
    setIsLoading(true);
    setErrorMessage('');
  ...
  const refreshAdminData = useCallback(async (areaSearch = query) => {
    await Promise.all([fetchOrganizationTree(areaSearch), fetchFormOptions()]);
  }, [fetchFormOptions, fetchOrganizationTree, query]);
                ...
                <div className="aop-form-grid two-up">
                  <form className="aop-form-card" onSubmit={(e) => { e.preventDefault(); setScaffoldMessage('Manager promotion'); }}>
                    ...
                    <div className="aop-form-note">
                      Assignment will follow the selected agent’s current unit and branch automatically.
                    </div>
                  ...
                  <form className="aop-form-card" onSubmit={(e) => { e.preventDefault(); setScaffoldMessage('Manager edit'); }}>
                    ...
                    <div className="aop-form-note">
                      Current assignment is derived from the promoted agent record and is no longer entered separately.
                    </div>
