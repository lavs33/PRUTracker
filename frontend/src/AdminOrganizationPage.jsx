  ...
  const filteredBranches = useMemo(
    () =>
      branchList.filter((branch) =>
        matchesSearch(
          `${branch.branchName} ${branch.areaName}`,
          branchSearch
        )
      ),
  ...
  const filteredUnits = useMemo(
    () =>
      unitList.filter((unit) =>
        matchesSearch(
          `${unit.unitName} ${unit.branchName} ${unit.areaName}`,
          unitSearch
        )
      ),
    [unitList, unitSearch]
  ...
  const filteredManagers = useMemo(
    () =>
      managerList.filter((manager) =>
        manager.managerType === managerTab &&
        matchesSearch(`${manager.username} ${manager.firstName} ${manager.lastName}`, managerSearch)
      ),
    [managerList, managerSearch, managerTab]
  );

  const filteredAgents = useMemo(
    () =>
      formOptions.agents.filter((agent) =>
        matchesSearch(`${agent.username} ${agent.firstName} ${agent.lastName}`, agentSearch)
      ),
                  ...
                  <div className="aop-form-grid">
                    {areaView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddArea}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" aria-label="Back to All Areas" onClick={() => setAreaView('list')}>←</button>
                        <button type="button" className="aop-cancel-btn" onClick={() => setAreaView('list')}>Cancel</button>
                  ...
                  <div className="aop-form-grid">
                    {branchView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddBranch}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" aria-label="Back to All Branches" onClick={() => setBranchView('list')}>←</button>
                        <button type="button" className="aop-cancel-btn" onClick={() => setBranchView('list')}>Cancel</button>
                  ...
                  <div className="aop-form-grid">
                    {unitView === 'add' ? (
                      <form className="aop-form-card" onSubmit={handleAddUnit}>
                        ...
                        />
                        <button type="button" className="aop-close-btn" aria-label="Back to All Units" onClick={() => setUnitView('list')}>←</button>
                        <button type="button" className="aop-cancel-btn" onClick={() => setUnitView('list')}>Cancel</button>
              ...
              <section className="aop-section aop-section-tight">
                {managerView === 'list' ? (
                    ...
                    <div className="aop-list-toolbar">
                      ...
                      <div className="aop-toolbar-actions">
                        ...
                        <button
                          ...
                          onClick={() => {
                            setCreateManagerForm((current) => ({ ...EMPTY_MANAGER_CREATE_FORM, managerType: managerTab }));
                            setManagerView('form');
                          }}
                        >
                  ...
                  <div className="aop-form-grid">
                    ...
                    <button type="button" className="aop-close-btn" aria-label="Back to All Managers" onClick={() => setManagerView('list')}>←</button>
                    <button type="button" className="aop-cancel-btn" onClick={() => setManagerView('list')}>Cancel</button>
              ...
              <section className="aop-section aop-section-tight">
                {agentView === 'list' ? (
                  ...
                  <div className="aop-form-grid">
                    ...
                    <button type="button" className="aop-close-btn" aria-label="Back to All Agents" onClick={() => setAgentView('list')}>←</button>
                    <button type="button" className="aop-cancel-btn" onClick={() => setAgentView('list')}>Cancel</button>
