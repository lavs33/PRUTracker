...
const HERO_IMAGE_SRC = "/images/landing-hero-random-01.jpg";
...
const MODULES = [
  {
    ...
    imageSrc: "/images/module-client-visibility-random-01.jpg",
  },
  {
    ...
    status: "Planned / In Progress",
    imageSrc: "/images/module-task-visibility-random-02.jpg",
  },
  {
    ...
    status: "Planned / In Progress",
    imageSrc: "/images/module-sales-analytics-random-03.jpg",
  },
  {
    ...
    status: "Planned / In Progress",
    imageSrc: "/images/module-orphan-kpi-random-04.jpg",
  },
];
      ...
      <main>
        <section id="overview" className="mp-hero">
          <div className="mp-hero-inner">
            ...
            <p>
              PRUTracker is designed to support Pru Life UK agents and managers with visibility dashboards, structured workflows,
            ...
            <figure className="mp-hero-imageWrap" aria-label="Header visual">
              <img
                src={HERO_IMAGE_SRC}
                alt="Pru Life UK CRM overview visual"
                className="mp-hero-image"
              />
              <figcaption>{HERO_IMAGE_SRC}</figcaption>
            </figure>
          </div>
        </section>
            ...
            {MODULES.map((module) => (
              <article key={module.title} className="mp-module-card">
                ...
                <figure className="mp-module-imageWrap">
                  ...
                  <figcaption>{module.imageSrc}</figcaption>
                </figure>
                <ul>
      ...
      <footer id="footer-contact" className="mp-footer">
        <div className="mp-footer-inner">
          ...
          <div className="mp-footer-col">
            ...
            <p>
              <a href="https://prism.prulifeuk.com.ph/" target="_blank" rel="noreferrer">PRISM - PRU Information Systems Management</a>
              <br />
              <a href="https://pruone.prulifeuk.com.ph/web" target="_blank" rel="noreferrer">PRUOnePH</a>
              <br />
              <a href="https://pruservices.prulifeuk.com.ph/welcome" target="_blank" rel="noreferrer">PRUServices</a>
            </p>
