...
const MODULES = [
  {
    ...
    imagePlaceholder: "Module Image Placeholder",
  },
  {
      ...
      <main>
        <section id="overview" className="mp-hero">
          <div className="mp-hero-inner">
            ...
            <div className="mp-hero-imagePlaceholder" aria-label="Header visual placeholder">
          ...
          <div className="mp-module-grid">
            {MODULES.map((module) => (
              <article key={module.title} className="mp-module-card">
                ...
                <p>{module.summary}</p>
                <div className="mp-module-imagePlaceholder">{module.imagePlaceholder}</div>
                <ul>
