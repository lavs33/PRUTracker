  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/aum/:username/profile" element={<ManagerProfile />} />
        <Route path="/um/:username/profile" element={<ManagerProfile />} />
        <Route path="/bm/:username/profile" element={<ManagerProfile />} />
