    ...
    pages.push(`
      <section class="pdf-page">
        ...
        <section class="section compact-top">
          <div class="analytics-grid">
            <div class="panel">
              <h4>Prospect Relationship Status</h4>
              <table>
                <thead><tr><th>Status</th><th>Count</th><th>Share</th></tr></thead>
        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; }
            ...
            .pdf-page { position: relative; min-height: 297mm; padding: 16mm 16mm 14mm; page-break-after: always; overflow: visible; break-after: page; }
            ...
            .report-footer { position: static; margin-top: 10mm; font-size: 9px; color: #6b7280; display:flex; justify-content:space-between; align-items:center; border-top: 1px solid #e5e7eb; padding-top: 3px; break-inside: avoid; page-break-inside: avoid; }
            table, tr, .panel, .section { break-inside: avoid; page-break-inside: avoid; }
          </style>
        </head>
