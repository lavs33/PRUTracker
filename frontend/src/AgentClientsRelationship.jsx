        ...
        <main className="cr-page-content">
          ...
          <div className="cr-content-card cr-dashboard-card">
            <div className="cr-kpis">
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Total Prospects</span><span className="cr-kpiValue">{totalProspects}</span></div>
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Total Policyholders</span><span className="cr-kpiValue">{totalPolicyholders}</span></div>
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Leads In Progress</span><span className="cr-kpiValue">{recentProspects.reduce((sum, p) => sum + Number(p.leadsInProgress || 0), 0)}</span></div>
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Open Tasks</span><span className="cr-kpiValue">—</span></div>
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Due Today</span><span className="cr-kpiValue">—</span></div>
              <div className="cr-kpiTile"><span className="cr-kpiLabel">Unread Notifications</span><span className="cr-kpiValue">—</span></div>
            </div>

            <div className="cr-grid">
              <div className="cr-panel">
                <h3 className="cr-panelTitle">Pipeline Snapshot</h3>
                <div className="cr-funnel">
                  {["Contacting", "Needs Assessment", "Proposal", "Application", "Policy Issuance"].map((stage) => (
                    <div key={stage} className="cr-stageRow">
                      <span className="cr-stageName">{stage}</span>
                      <span className="cr-stageValue">—</span>
                    </div>
                  ))}
                </div>
                <p className="cr-muted">UI-only preview: stage counts to be wired next.</p>
              </div>

              <div className="cr-panel">
                <h3 className="cr-panelTitle">Needs Attention</h3>
                ...
                <p className="cr-muted">UI-only preview: actionable lists to be connected to APIs.</p>
              </div>
            </div>
