      ...
      <section class="pdf-page">
        <section class="section compact-top">
          ...
          <table>
            ...
            <tbody>${pipelineLeadRows || '<tr><td colspan="4">No ongoing leads for this selected period.</td></tr>'}</tbody>
          </table>
        </section>
        <section class="section spacious-section">
            ...
            <div className="cr-grid">
              ...
              <section className="cr-panel">
                <div className="cr-panelHeader">
                  ...
                  <span className="cr-panelMeta">Selected-period policyholders; active policyholders only</span>
                </div>
              ...
              <section className="cr-panel cr-panel-wide">
                ...
                <DetailList type="lead" rows={ongoingLeadDetails} empty="No ongoing leads for this selected period." />
              </section>
