...
function AgentClientsRelationship() {
  ...
  const generatePdfReport = () => {
    ...
    const agentFullName = [user?.firstName, user?.middleName, user?.lastName].filter(Boolean).join(" ") || "—";
          ...
          <div class="top-grid">
            ...
            <div class="details-card">
              ...
              <div class="details-grid">
                ...
                <div class="detail-item detail-item-wide"><b>Name</b>${escapeHtml(agentFullName)}</div>
